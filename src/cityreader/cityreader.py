...
input_one = input("enter latitude 1 and longitude 1 seperated by comma (ex: -22,100): ")
input_two = input("enter latitude 2 and longitude 2 seperated by comma (ex: -25,80): ")
